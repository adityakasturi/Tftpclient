 ...
 * ErrorPacket.java
 *
 * ErrorPacket is used to describe the type of errors which occur with packets
 * in TFTP
 *
...
public class ErrorPacket extends Packet {
    ...
    public Packet deserializePacket(byte[] data) 
    		throws TftpFormatException, IOException {
        DataInputStream in = 
        		new DataInputStream(new ByteArrayInputStream(data));

        if(in.readShort() != 
        		TftpOpCodesEnum.ERROR) throw new TftpFormatException("Wrong opcode");
