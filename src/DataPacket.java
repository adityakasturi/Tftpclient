 ...
 * DataPacket.java
 *
 * The DataPacket which is used to set the packet format for TFTP Application
 *
...
public class DataPacket extends Packet implements PacketInterface {
	/**
	 * Variables which are used to support the Packet Structure that is followed by
	 * RFC 1350
	 */
